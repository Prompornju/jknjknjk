Public Class frmLab4
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtSalary.TextChanged, txtSale.TextChanged
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles radShortDate.CheckedChanged
